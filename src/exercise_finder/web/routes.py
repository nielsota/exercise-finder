# mypy: ignore-errors
"""Main application routes for the web application."""
...
def create_main_router(templates: Jinja2Templates, exams_root: Path) -> APIRouter:
    """
    ...
    Returns:
        APIRouter with main application routes
    """
    ...
    @router.post("/api/refresh-config")
